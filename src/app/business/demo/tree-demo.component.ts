       ...
       <div class="row">
          <div  class="col-md-12">
              <p class="c-line-title">示例</p>
               <c-tree #t [data]="data" [canChecked]="true"
                [singleChecked]="false" [cascadeChecked]="true"
                 [hideParentCheckBox]="false" [singleCheckedNodeId]="singleCheckedNodeId"
                   [animatedCls]="'animated fadeIn'" (onClick)="onClick($event);"
                    (onCheckChanged)="onCheckChanged($event)"></c-tree>
              ...
              <div class="row c-mt15">
                <div  class="col-md-6">
                  <c-seelct-tree #tree1 [data]="data2" [canChecked]="true"
                   [singleChecked]="false" [cascadeChecked]="true" [hideParentCheckBox]="false"
                    [singleCheckedNodeId]="singleCheckedNodeId"  [animatedCls]="'animated fadeIn'"
                     (onClick)="onClick($event);" (onCheckChanged)="onCheckChanged($event)"></c-seelct-tree>
                </div>
              </div>
              <div class="row c-mt15">
                <div  class="col-md-6">
              ...
              <div class="row c-mt15">
                <div  class="col-md-6">
                  <c-seelct-tree  #tree2 [data]="data3" [canChecked]="false"
                   [enableSearch]="false" [animatedCls]="'animated fadeIn'"
                     [direction]="'dropup'" (onClick)="onClick($event);" (onCheckChanged)="onCheckChanged($event)"></c-seelct-tree>
                </div>
              </div>
          </div>
        </div>
...
export class TreeDemoComponent implements OnInit {
  ...
  getData() {
    window.console.info(this.t.getData());
  }
  ...
  getCheckedData() {
    window.console.info(this.t.getCheckedData());
  }
  ...
  getTreeCheckedData() {
    window.console.info(this.tree1.getCheckedData());
  }

  getTreeData() {
    window.console.info(this.tree1.getData());
  }
